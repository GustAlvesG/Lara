@php
     ...
     *
     * REDAÇÃO 1 — CONGELADA. Contratos assinados apontam para esta pasta pelo
     * `contract_version`, e um teste lacra os arquivos dela pelo sha256. Para
     * revisar uma cláusula, copie a pasta para `v2` e edite lá: alterar este
     * arquivo mudaria o texto de contratos já firmados.
     *
...
@include('freelancer.services.partials.contract.v1.pix-clause', ['service' => $service, 'numero' => '2.1'])
