...
<a href="{{ route('place-group.show', $item->id) }}" class="block transform hover:scale-[1.02] transition duration-300">
    <div class="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-2xl border border-gray-100 dark:border-gray-700">
        ...
        <div class="p-4">
            ...
            <h3 class="text-xl font-extrabold text-gray-900 dark:text-white mb-1 leading-tight">
                {{ $item['name'] }}
            </h3>

            <!-- Categoria / Tipo -->
            <p class="text-xs text-indigo-700 dark:text-indigo-400 font-semibold mb-3">
            ...
            <div class="flex justify-between items-center border-t border-gray-100 dark:border-gray-700 pt-3">
                ...
                <!-- Contagem de Quadras -->
                <div class="text-sm text-gray-700 dark:text-gray-300 font-medium flex items-center">
                ...
                <div class="text-lg font-extrabold text-green-600">
                    R$ {{ $minPrice }} 
                    <span class="text-xs font-normal text-gray-500 dark:text-gray-400">/hora</span>
                </div>
            </div>
