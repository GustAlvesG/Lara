                ...
                <x-slot name="content">
                    <form action="{{ route('schedule.update') }} " method="POST">
                        ...
                        @if(isset($other_schedules) && $other_schedules->count() > 0)
                            ...
                            <div class="p-4 mb-4 rounded-lg bg-indigo-50 dark:bg-indigo-900 border border-indigo-200 dark:border-indigo-700 shadow-md">
                                <span class="text-indigo-800 dark:text-indigo-200 font-semibold text-base leading-tight">
