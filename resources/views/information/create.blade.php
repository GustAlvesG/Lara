    ...
    <div class="py-6">        
        <div class="mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-6 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg row">
                <div class="col-6">
                    @include('information.partials.form-create', ['route' => route('information.store')])
                </div>
                <div class="col-6 justify-center">
                    ...
                    <div class="row">
                        @include('information.partials.optionalFields-create') 
                    </div>
                    <div class="row">
                        @include('information.partials.optionalFieldsButtons-create') 
                    </div>
                </div>
            </div>
        </div>
