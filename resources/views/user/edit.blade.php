                            ...
                            <div>
                                ...
                                <select name="role_id" id="role_id" required
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{ $role['id'] }}" {{ ($user['roles'][0]['id'] ?? null) == $role['id'] ? 'selected' : '' }}>
                                            {{ $role['name'] }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                        <div class="p-6 border-b border-gray-50 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/50">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                6 dígitos usados no Kiosk de contratos.
                                {{ $user->hasPin() ? 'Já definido — preencha para trocar.' : 'Ainda não definido.' }}
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="pin" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Novo PIN (6 dígitos)</label>
