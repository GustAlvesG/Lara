...
<div class="rule-card {{ $rule->applicable ? "rule-card-access" : 'rule-card-block' }} border p-4 rounded shadow-sm text-gray-800 dark:text-gray-200 leading-tight font-bold text-lg mb-2 ">
