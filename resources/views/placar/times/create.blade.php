            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="equipe_id" required class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Ex.: Adulto, Sub-15, Sub-17.</p>
                    ...
                    <div>
                        ...
                        <input type="text" name="nome_exibicao" value="{{ old('nome_exibicao') }}"
                            class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
                        <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Se vazio, é montado a partir da equipe + categoria.</p>
                    </div>
                </div>
            </div>

            <div class="mt-6 flex justify-end gap-3">
                <a href="{{ route('placar.times.index') }}" class="px-6 py-3 rounded-xl font-bold text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition">Cancelar</a>
