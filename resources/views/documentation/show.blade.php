<x-app-layout>
    ...
    <style>
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .markdown-body h3, .markdown-body h4 { color: #f9fafb; }
            .markdown-body h1 { border-bottom-color: #374151; }
            .markdown-body h2 { border-bottom-color: #1f2937; }
            .markdown-body a { color: #f87171; }
            .markdown-body code { background: #374151; color: #fca5a5; }
            .markdown-body blockquote { background: #7f1d1d33; color: #d1d5db; }
            .markdown-body th, .markdown-body td { border-color: #374151; }
            .markdown-body th { background: #111827; }
            .markdown-body tr:nth-child(even) td { background: #1f2937; }
